...
import { type User, type Profile, type Order, type OrderStatus, type AgentReport, type RewardRequest } from "@/lib/api";
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          for (const order of ordersData) {
            ...
            if (typeof order.agentId === 'string') {
              ...
              orderAgentId = String((order.agentId as any).id || (order.agentId as any)._id || '').trim();
            } else {
            ...
            if (orderAgentId === userAgentId && (order.status === "agent_sudlaj_bn" || order.status === "tolbor_huleej_bn" || order.status === "amjilttai_zahialga")) {
              try {
        ...
        try {
          ...
          console.error("Failed to load reward requests:", err);
          setRewardRequests([]);
        }
      } catch (err: any) {
  ...
  const publishedOrders = useMemo(() => {
    ...
    if (user?.role === "agent") {
      return orders.filter(order =>
        order.status === "niitlegdsen" && !order.agentId
      );
    }
  ...
  const myOrders = useMemo(() => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log('myOrders filter result:', {
        ...
        allOrderAgentIds: orders.filter(o => o.agentId).map(o => ({
          id: o.id,
      ...
      <main className="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 border-b border-gray-200">
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium transition ${orderFilter === "active"
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium transition ${orderFilter === "completed"
                      ? "text-blue-600 border-b-2 border-blue-600"
                      : "text-gray-600 hover:text-gray-900"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium transition ${orderFilter === "cancelled"
                      ? "text-blue-600 border-b-2 border-blue-600"
                      : "text-gray-600 hover:text-gray-900"
                      }`}
                  >
          ...
          {user?.role === "agent" && (
            <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6">
              <div className="flex justify-between items-center mb-3 sm:mb-4">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Урамшуулал</h2>
                <button
              ...
              {showRewards && (
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-900 mb-3">Урамшууллын хүсэлтүүд</h3>
                          ...
                          >
                            <div className="flex justify-between items-start">
                              ...
                              <div className="text-right">
                                ...
                                {request.approvedAt && (
                                  <p className="text-xs text-gray-500 mt-1">
                                    Батлагдсан: {new Date(request.approvedAt).toLocaleDateString("mn-MN", {
                                      year: "numeric",
                                      month: "long",
                                      day: "numeric",
                                    })}
            ...
            <div className="bg-white rounded-none sm:rounded-xl border border-gray-200 max-w-2xl w-full h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${selectedOrder.status === "niitlegdsen" ? "bg-gray-100 text-gray-800" :
