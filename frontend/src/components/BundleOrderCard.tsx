...
export const BundleOrderCard: React.FC<BundleOrderCardProps> = ({
  ...
  return (
    <div className="bg-linear-to-br from-white to-gray-50 rounded-2xl border border-gray-200 shadow-md hover:shadow-xl hover:border-purple-300 hover:scale-[1.01] transition-all duration-300 overflow-hidden p-4">
