        ...
        <div className="bg-white rounded-none sm:rounded-xl border border-gray-200 max-w-2xl w-full h-full sm:h-auto sm:max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {bundleOrder.items.length} бараа
                </p>
              </div>
            </div>
            <button
          ...
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`px-3 py-1 rounded-lg text-sm font-medium ${getStatusColor(bundleOrder.status)}`}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {bundleOrder.userSnapshot.name}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500">Утас</p>
                  <p className="text-sm font-medium text-gray-900">
                    {bundleOrder.userSnapshot.phone}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500">Карго</p>
                  <p className="text-sm font-medium text-gray-900">
                    {bundleOrder.userSnapshot.cargo}
                  </p>
                </div>
              </div>
            </div>
    ...
    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {item.agentReport && (
              <p className="text-xs text-green-600 font-medium mt-1">
                {item.agentReport.userAmount.toLocaleString()}¥ (
                {(item.agentReport.userAmount * exchangeRate).toLocaleString()}
                ₮)
              </p>
            )}
          </div>
          ...
          <div className="flex items-center gap-2">
            <span
              className={`px-2 py-0.5 rounded-full text-xs font-medium shrink-0 ${getStatusColor(item.status)}`}
            >
