      ...
      <div className="flex items-center justify-end gap-2 mt-3 pt-3 border-t border-gray-100">
        ...
        {canArchive && onArchive && (
          <button
            ...
            disabled={archiveLoading}
            className="h-8 px-3 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg text-xs font-medium transition-all inline-flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {archiveLoading ? (
